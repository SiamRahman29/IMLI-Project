from app.routes.helpers import scrape_jugantor
import json

if __name__ == "__main__":
    articles = scrape_jugantor()
    ...
    def default_serializer(obj):
        ...
        return str(obj)
    with open("jugantor_scraped.json", "w", encoding="utf-8") as f:
        json.dump(articles, f, ensure_ascii=False, indent=2, default=default_serializer)
    print("Scraped articles saved to jugantor_scraped.json")
