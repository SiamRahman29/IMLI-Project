from app.routes.helpers import scrape_inqilab
import json

if __name__ == "__main__":
    articles = scrape_inqilab()
    ...
    def default_serializer(obj):
        ...
        return str(obj)
    with open("inqilab_scraped.json", "w", encoding="utf-8") as f:
        json.dump(articles, f, ensure_ascii=False, indent=2, default=default_serializer)
    print("Scraped articles saved to inqilab_scraped.json")
