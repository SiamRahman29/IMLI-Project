...
class CategoryLLMAnalyzer:
    ...
    def _create_category_prompt(self, category: str, content_text: str) -> str:
        ...
        prompt = f"""
তুমি একজন বিশেষজ্ঞ বাংলাদেশি সংবাদ বিশ্লেষক। তোমার কাজ হল '{category}' ক্যাটাগরির সংবাদ থেকে বর্তমানে সবচেয়ে ট্রেন্ডিং ও গুরুত্বপূর্ণ ৮টি শব্দ/বাক্যাংশ চিহ্নিত করা।

বিশ্লেষণের নিয়মাবলী:
1. **ক্যাটাগরি ফোকাস**: শুধুমাত্র '{category}' সম্পর্কিত ট্রেন্ডিং topic নিয়ে কাজ করো
2. **ট্রেন্ডিং অগ্রাধিকার**: যে topic গুলো বারবার আসছে এবং আলোচিত হচ্ছে
